...
class InvoiceMemo(BaseClass):
    ...
    def calculate_totals(self):
        ...
        # FINAL NET AMOUNT = Outstanding + Previous + Current.
        # The Current/Advance month IS billed (payable in advance). The Previous
        # month's net already reflects the reconciliation (its other_deductions
        # carry the advance billed for that month last cycle), so the same month
